...
private fun generateSampleData(): List<TreeNode> {
    return listOf(
        TreeNode(
            "Folder 1", listOf(
                TreeNode("File 1.1"), TreeNode("File 1.2"), TreeNode(
                    "Folder 1.3", listOf(
                        TreeNode("File 1.3.1"), TreeNode(
                            "File 1.3.2", listOf(TreeNode("File name 5"))
                        )
                    )
                )
            )
        ...
        TreeNode(
            "Folder 3", listOf(
                TreeNode("File 3.1"), TreeNode(
                    "Folder 3.2", listOf(
                        TreeNode("File 3.2.1"), TreeNode("File 3.2.2")
                    )
                ), TreeNode("File 3.3")
            )
        )
